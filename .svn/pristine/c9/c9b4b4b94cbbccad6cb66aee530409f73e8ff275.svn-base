...
CXann={ANN_2HL_Linear,ANN_1HL_CubicSplineFULL,...
...
V2HL_Out=transpose(ANN_2HL_Linear(MTestInput));
ERR_2HL=(V2HL_Out-MTestOutput').^2;
V1HLfull_Out=nneval_tian(ANN_1HL_CubicSplineFULL{1},ANN_1HL_CubicSplineFULL{2},ANN_1HL_CubicSplineFULL{3},(MTestInput));
ERR_V1HLfull=(V1HLfull_Out'-MTestOutput').^2;
V2HLpruned_Out=nneval_tian(ANN_1HL_CubicSplinePRUNED{1},ANN_1HL_CubicSplinePRUNED{2},ANN_1HL_CubicSplinePRUNED{3},(MTestInput));
ERR_V2HLpruned=(V2HLpruned_Out-MTestOutput).^2;
GMDH_Out=gmdhpredict(ANN_GMDH_CubicSpline{1},(MTestInput'));
ERR_GMDH=(GMDH_Out-MTestOutput').^2;
...
subplot(2,1,1)
hold all
plot(1:length(MTestOutput),Vrobust_BMS*200,'LineWidth',2);
...
plot(1:length(MTestOutput),MOutput);
ylim([-10,210])
xlabel('Samples')
ylabel('BreakLevel')
grid on
...
subplot(2,1,2)
hold all
plot(1:length(MTestOutput),(Vrobust_BMS-MTestOutput').^2,'LineWidth',2);
plot(1:length(MTestOutput),(Mrobust(:,BestABMSet)-MTestOutput').^2);
